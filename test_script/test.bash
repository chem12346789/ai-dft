...
~/anaconda3/bin/python test.py -dl -0.1 0.1 3 -b cc-pCVDZ --extend_atom 0 --extend_xyz 0 --load 2024-06-24-17-56-33 --name_mol methane --hidden_size 64 --residual 0 --num_layer 2
