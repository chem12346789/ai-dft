...
#
~/anaconda3/envs/pyscf/bin/python test.py -dl -0.5 0.5 11 -b cc-pVDZ --extend_atom 0-1 --extend_xyz 0 --load CHECKPOINT --name_mol methane ethane ethylene acetylene propane propyne propylene allene cyclopropene cyclopropane benzene cyclopentane isopentane pentane butane butyne isobutane butadiene --input_size INPUT_SIZE --hidden_size HIDDEN_SIZE --output_size OUTPUT_SIZE --residual RESIDUAL --num_layer NUM_LAYER --precision float64 --load_epoch -1 >log/CHECKPOINT.out
#
