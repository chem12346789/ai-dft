...
#
# ~/anaconda3/envs/pyscf/bin/python test.py -dl -0.475 2.425 30 -b cc-pCVTZ --extend_atom 1-2 --extend_xyz 0 --load CHECKPOINT --name_mol ethane --input_size INPUT_SIZE --hidden_size HIDDEN_SIZE --output_size OUTPUT_SIZE --residual RESIDUAL --num_layer NUM_LAYER --require_grad True --precision float64 --load_epoch -1 >log/CHECKPOINT.out
# ~/anaconda3/envs/pyscf/bin/python test.py -dl -0.425 2.475 30 -b cc-pCVTZ --extend_atom 0-1 --extend_xyz 0 --load CHECKPOINT --name_mol methane --input_size INPUT_SIZE --hidden_size HIDDEN_SIZE --output_size OUTPUT_SIZE --residual RESIDUAL --num_layer NUM_LAYER --require_grad True --precision float64 --load_epoch -1 >log/CHECKPOINT.out
# ~/anaconda3/envs/pyscf/bin/python test.py -dl -0.5 0.5 11 -b cc-pCVTZ --extend_atom 0-1 --extend_xyz 0 --load CHECKPOINT --name_mol benzene cyclopentane isopentane pentane butane butyne isobutane butadiene propane propyne propylene allene cyclopropene cyclopropane methane ethane ethylene acetylene --input_size INPUT_SIZE --hidden_size HIDDEN_SIZE --output_size OUTPUT_SIZE --residual RESIDUAL --num_layer NUM_LAYER --require_grad True --precision float64 --load_epoch -1 >log/CHECKPOINT.out
