...
# 
# ~/anaconda3/envs/pyscf/bin/python test.py -dl -0.45 0.45 10 -b cc-pCVTZ --extend_atom 0 --extend_xyz 0 --load CHECKPOINT --name_mol hexane 2-methylpentane 3-methylpentane 2,2-dimethylbutane 2,3-dimethylbutane cyclohexane 1-hexene methylcyclopentane 3,3-dimethyl-1-butene 4-methyl-1-pentene 2-methyl-1-pentene propylcyclopropane --input_size INPUT_SIZE --hidden_size HIDDEN_SIZE --output_size OUTPUT_SIZE --residual RESIDUAL --num_layer NUM_LAYER --precision float32 --load_epoch -1 >log/CHECKPOINT.out