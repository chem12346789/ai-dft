...
#
# ~/anaconda3/envs/pyscf/bin/python test.py -dl -0.5 0.5 11 -b cc-pCVTZ --extend_atom 0 --extend_xyz 0 --load xieyi-1 --name_mol methane benzene cyclopentane isopentane pentane butane butyne isobutane butadiene propane propylene propyne allene methyl-openshell ethane ethylene acetylene cyclopropene cyclopropane --input_size INPUT_SIZE --hidden_size HIDDEN_SIZE --output_size OUTPUT_SIZE --residual RESIDUAL --num_layer NUM_LAYER --precision float32 --load_epoch -1 --level 3 >log/CHECKPOINT.out
#
#
