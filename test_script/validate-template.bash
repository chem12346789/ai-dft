...
~/anaconda3/bin/python test.py -dl -0.45 0.45 10 -b cc-pCVDZ --extend_atom 0 --extend_xyz 0 --load CHECKPOINT --name_mol propyne propylene allene cyclopropene cyclopropane butane butyne isobutane butadiene --hidden_size HIDDEN_SIZE --residual RESIDUAL --num_layer NUM_LAYER --precision float32
