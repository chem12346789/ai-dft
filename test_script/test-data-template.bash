...
~/anaconda3/envs/pyscf/bin/python test.py -dl -1.0 2.5 36 -b cc-pCVTZ --extend_atom 0 2 0-1 0-2 0-3 0.2-1.3 --extend_xyz 0 --load data --name_mol methane ethane ethylene acetylene cyclopropene cyclopropane propane propylene propyne allene --from_data True >log/data.out
#
