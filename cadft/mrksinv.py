...
class Mrksinv:
    ...
    def inverse(self):
        ...
        for i in range(25000):
            ...
            if (i > 0) and (self.error_vxc < 1e-6):
                break
    ...
    def check(self):
        ...
        save_data = {}
        save_data["energy_dft"] = self.unitau * (self.mdft.e_tot - self.e)
        save_data["energy"] = self.unitau * self.e
        save_data["correct kinetic energy"] = kin_correct * self.unitau
        save_data["correct kinetic energy1"] = kin_correct1 * self.unitau
