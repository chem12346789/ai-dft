...
class DuckNet(nn.Module):
    def __init__(self, input_channels: int, num_classes: int, num_filters: int = 17):
        ...
        self.conv11 = ConvBlock(
            input_channels, num_filters * 2, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv21 = ConvBlock(
            num_filters * 2, num_filters * 4, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv31 = ConvBlock(
            num_filters * 4, num_filters * 8, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv41 = ConvBlock(
            num_filters * 8, num_filters * 16, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv51 = ConvBlock(
            num_filters * 16, num_filters * 32, 2, 2, 0, is_relu=False, is_bn=False
        )
        ...
        self.conv12 = ConvBlock(
            num_filters, num_filters * 2, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv22 = ConvBlock(
            num_filters * 2, num_filters * 4, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv32 = ConvBlock(
            num_filters * 4, num_filters * 8, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv42 = ConvBlock(
            num_filters * 8, num_filters * 16, 2, 2, 0, is_relu=False, is_bn=False
        )
        self.conv52 = ConvBlock(
            num_filters * 16, num_filters * 32, 2, 2, 0, is_relu=False, is_bn=False
        )
        ...
        self.last_conv = nn.Sequential(
            nn.Conv2d(num_filters, num_classes, 1, 1, 0), nn.Sigmoid()
        )
