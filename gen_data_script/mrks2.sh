...
~/anaconda3/bin/python gen_dm_ene.py -dl 0.3 0.5 3 -b cc-pCVTZ --extend_atom 0 --extend_xyz 0 --name_mol methane ethane ethylene acetylene propane --load_inv True
